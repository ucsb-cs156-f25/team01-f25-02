...
public class ArticlesControllerTests extends ControllerTestCase {
  ...
  public void an_admin_user_can_post_a_new_article() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/articles/post?title=First-Article&url=http://example.com/1&explanation=This-is-the-first-article&email=user@example.com&dateAdded=2022-01-03T00:00:00")
                    .with(csrf()))
  ...
  public void admin_can_edit_an_existing_article() throws Exception {
    ...
    verify(articleRepository, times(1)).save(editedArticle); // should be saved with correct user
    String responseString = response.getResponse().getContentAsString();
  ...
  public void admin_cannot_edit_article_that_does_not_exist() throws Exception {
    ...
    String requestBody = mapper.writeValueAsString(edtitedArticle);
