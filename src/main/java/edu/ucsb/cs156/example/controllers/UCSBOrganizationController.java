...
public class UCSBOrganizationController extends ApiController {
   ...
   *
   * @param orgCode
   * @param orgTranslationShort brief name of the ucsb organization
   * @param orgTranslation name of the ucsb organization
   * @param inactive whether or not the ucsb organization is inactive
   * @return the save ucsb organization
   */
